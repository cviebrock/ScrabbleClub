<div class="page-header">
	<?php echo action_link_to_route('admin.games@new', '', array(), 'plus|white', array('class'=>'btn btn-primary pull-right')); ?>
	<h1>Games</h1>
</div>
...
foreach ($games as $game) {
		...
		if (!$game->unmatched_games) {
			if (array_key_exists($game->date, $ratings) &&
				...
				echo '<li>' . action_link_to_route('admin.games@ratings', 'View Ratings', array($game->date), 'small|signal' ) . '</li>';
			} else if (!$shown_update) {
				echo '<li>' . action_link_to_route('admin.games@update_ratings', 'Update Ratings', array($game->date), 'small|signal' ) . '</li>';
				$shown_update = true;
			}
		}
...
<?php echo action_link_to_route('admin.games@new', 'Add new games', array(), 'plus|white', array('class'=>'btn btn-primary pull-right')); ?>
